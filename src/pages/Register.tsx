  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      toast({
        ...
        description: "Welcome to TruthGuard AI. Let's fight misinformation together!",
      });
    } else {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-white/80 backdrop-blur-md border-white/20">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Join TruthGuard AI</CardTitle>
          <CardDescription>
            Create your account to start detecting misinformation
          </CardDescription>
        </CardHeader>
        <CardContent>
